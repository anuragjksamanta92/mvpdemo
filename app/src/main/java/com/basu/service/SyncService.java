...
import com.basu.di.component.DaggerServiceComponent;
import com.basu.di.component.ServiceComponent;
import com.basu.di.module.ServiceModule;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        ...
        ServiceComponent component = DaggerServiceComponent.builder()
                ...
                .applicationComponent(((BasuApp) getApplication()).getComponent())
                .build();
